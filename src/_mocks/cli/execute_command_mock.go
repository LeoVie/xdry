...
// Source: internal/normalize/normalize.go

// Package mock_normalize is a generated GoMock package.
package cli
...
func (m *MockCommandExecutor) Execute(arg0 string, arg1 []string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommandExecutorMockRecorder) Execute(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockCommandExecutor)(nil).Execute), arg0, arg1)
}
